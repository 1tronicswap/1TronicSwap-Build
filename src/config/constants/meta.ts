...
export const DEFAULT_META: PageMeta = {
  title: '1TronicSwap',
  description:
    'The First Choice AMM on BSC in Indonesia by user count! Buy 1TRC with BIDR,Earn 1TRC through yield farming or win it in the Lottery, then stake it in Staking Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by 1TronicSwap), NFTs, and more, on a platform you can trust.',
