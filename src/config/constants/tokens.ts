import { ChainId, Token } from 'utils/@sdk'
...
export const OneTronic: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0xf75eff165ffe652548b9c3259465f10f5479b7b5',
    18,
    '1TRC',
    'OneTronic Network',
  ),
...
export const BIDR = new Token(ChainId.MAINNET, '0x9A2f5556e9A637e8fBcE886d8e3cf8b316a1D8a2', 18, 'BIDR', 'Binance IDR')
