import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from 'utils/@sdk'
import { useMemo } from 'react'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import { BUSD, e1TRC } from '../config/constants/tokens'
...
export const useCakeBusdPrice = (): Price | undefined => {
  ...
  const cakeBusdPrice = useBUSDPrice(e1TRC[currentChaindId])
